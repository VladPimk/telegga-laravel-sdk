...
Реализованы HTTP-клиент, локальная модель подключения, создание подключения, явный повтор неудачной отправки и отправка текстовых сообщений. Остальные маршруты API и обработка вебхуков добавляются поэтапно.
